...
from combo_mcp.tools.search_products import search_products as _search_products
from combo_mcp.tools.list_categories import list_categories as _list_categories
